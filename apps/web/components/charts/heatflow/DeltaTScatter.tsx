  ...
  return (
    <div className={styles.scrollBox} data-testid="heatflow-scatter">
      <svg
        ...
        role="img"
        aria-label="Envelope conduction versus ambient-shelter temperature difference"
      ...
      <p className={styles.caption} data-testid="scatter-fit-stats">
        Fitted slope {fit.slope.toFixed(2)} W/K, R² {fit.r2.toFixed(3)} — envelope conduction (Q5)
        vs. ambient–shelter ΔT.
      </p>
    </div>
  );
}
