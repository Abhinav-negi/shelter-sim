...
| B | Engine | 12 / 16 | `log/AREA-B-engine.md` |
...
| [!] | T-21 | Couple infiltration to opening area (closes AUDIT F-6) | T-06 |
...
| [ ] | T-25 | The weather pipeline, with the mandatory lapse-rate correction | T-24 |
| [ ] | T-26 | NASA POWER and Open-Meteo request builders and response parsers | T-25 |
| [ ] | T-27 | Bundled TMY for Leh, Kargil, Drass, Nubra and Jaisalmer | T-25, T-26 |
