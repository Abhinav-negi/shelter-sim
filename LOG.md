...
| F | Frontend | 9 / 12 | `log/AREA-F-frontend.md` |
...
### Area F — Frontend — 9 / 12 (T-52 `[!]`, blocked on cross-component dependencies outside its allow-list — see its Evidence block) — `log/AREA-F-frontend.md`
