...
const FINISH_SOURCE_NOTE =
  'solar absorptance/emissivity: BLUEPRINT.md Appendix B surface finish table';
...
export const MATERIALS: readonly Material[] = [
  ...
  },
  {
    ...
    blurb:
      'Rammed earth: thick packed-earth walls, the classic heavy Ladakhi wall that stays warm all night.',
  },
  {
    ...
    blurb:
      'Stone masonry: heavy local stone walls, plentiful in Ladakh and excellent at storing heat.',
  },
  {
    id: 'firedClayBrick',
    ...
    blurb:
      'Fired brick: kiln-baked brick, sturdy and widely used, but trucked in rather than made on site.',
  },
  {
    id: 'denseConcrete',
    name: 'Dense concrete',
    ...
    blurb:
      'Dense concrete: heavy, strong and a good heat store, but cement has to be brought over the passes.',
  },
  {
    id: 'rcc',
  ...
  },
  {
    ...
    blurb:
      'AAC block: light factory-made block, insulates better than ordinary concrete but has to be shipped in.',
  },
  {
    ...
    blurb:
      'Poplar and willow timber: locally grown, used for roof beams and lattice, insulates fairly well on its own.',
  },
  {
    ...
    blurb:
      'Compressed earth block: machine-pressed earth block, a more uniform cousin of mud brick.',
  },
  {
    id: 'mudPlaster',
    name: 'Mud plaster',
  ...
  },
  {
    ...
    blurb:
      'Cement plaster: modern smooth render coat, more durable than mud plaster but needs bought-in cement.',
  },
  ...
  // bias a simulation.
  {
    ...
    blurb:
      'EPS foam board: light insulation board, very effective but shipped in from outside Ladakh.',
  },
  {
    id: 'xps',
    name: 'XPS',
    ...
    locallyAvailableLadakh: false,
    source:
      'Manufacturer datasheet, extruded polystyrene board (e.g. Dow STYROFOAM / Supreme XPS technical data sheet).',
    blurb:
      'XPS foam board: denser cousin of EPS, holds up better under load or damp, also shipped in.',
  },
  {
    id: 'puf',
    name: 'PUF / PIR',
    ...
    locallyAvailableLadakh: false,
    source:
      'Manufacturer datasheet, rigid polyurethane foam board (e.g. Kingspan / Supreme PUF technical data sheet).',
    blurb:
      'PUF board: the best-insulating foam board available, often bonded straight onto a metal roof sheet.',
  },
  {
    id: 'glassWool',
    name: 'Glass wool',
    ...
    locallyAvailableLadakh: false,
    source:
      'IS 8183:1993, Specification for bonded mineral wool; manufacturer datasheet (e.g. UP Twiga / Owens Corning glass wool technical data sheet).',
  ...
  },
  {
    ...
    locallyAvailableLadakh: false,
    source:
      'IS 8183:1993, Specification for bonded mineral wool (rock wool); manufacturer datasheet (e.g. Rockwool India technical data sheet).',
    blurb:
      'Rock wool: denser mineral-fibre batt, also fireproof, a heavier alternative to glass wool.',
  },
  {
    id: 'strawBale',
    name: 'Straw bale',
    ...
    locallyAvailableLadakh: true,
    source:
      'ASHRAE Handbook of Fundamentals Ch. 26, Table 4 (straw, agricultural material), cross-checked against published straw-bale construction literature.',
    blurb:
      'Straw bale: baled farm straw used as a thick wall infill, insulates well and is grown right on the farm.',
  },
  {
    id: 'sheepWool',
    name: 'Sheep wool',
    ...
    locallyAvailableLadakh: true,
    source:
      'Manufacturer datasheet, sheep-wool insulation batt (e.g. Thermafleece / Black Mountain sheep wool technical data sheet).',
    blurb:
      "Sheep wool: insulation felted from local sheep's wool, renewable and simple to install by hand.",
  },
  {
    id: 'airGap25mm',
    ...
    blurb:
      'Sealed air gap: a still 25 millimetre pocket of trapped air left inside a wall, a free layer of insulation.',
  },
  ...
  // ---------------------------------------------------------------- other
  {
    ...
    blurb:
      'Corrugated steel sheet: the common lightweight roofing sheet, cheap and quick to put up but a poor insulator on its own.',
  },
  {
    id: 'cgiBright',
    ...
    blurb:
      'Freshly galvanised roofing sheet: shiny when new, reflects most sunlight until it starts to weather.',
  },
  {
    id: 'water',
    ...
    locallyAvailableLadakh: true,
    source:
      'ASHRAE Handbook of Fundamentals Ch. 33, Table 2 (physical properties of water); a matte dark drum surface is assumed for the absorptance value.',
    blurb:
      'Water in drums: the simplest heat battery, soaks up sun through the day and gives it back at night.',
  },
  {
    id: 'gravelSoilFill',
    ...
    locallyAvailableLadakh: true,
    source:
      'IS 3792:1978 Table 1 (soil, gravel fill); ASHRAE Handbook of Fundamentals Ch. 26 Table 4 (soil).',
    blurb:
      'Gravel or soil fill: packed earth or stone chips under a floor, adds cheap mass that steadies the temperature.',
  },
  {
    id: 'pcmParaffinRT25',
    ...
    blurb:
      'Paraffin wax heat pack: melts and re-freezes near room warmth, storing a lot of heat in a small, light package, but it is a manufactured import.',
  },
  ...
  // ---------------------------------------------------------------- finishes (standalone)
  {
    ...
    blurb:
      'Whitewash: traditional lime coating brushed onto a wall every year, keeps walls bright and bounces away summer sun.',
  },
  {
    id: 'whitePaint',
    name: 'White paint',
    ...
    blurb:
      'White paint: a modern painted finish, longer-lasting than whitewash and just as good at reflecting sunlight.',
  },
  {
    id: 'blackPaint',
    name: 'Black paint',
    ...
    blurb:
      'Black paint: a dark coating used on a sun-facing storage wall or water drum to pull in as much heat as possible.',
  },
] as const;
