...
export const CONSTRUCTIONS: readonly NamedConstruction[] = [
  {
    ...
    source: 'BLUEPRINT.md Appendix B; a single-leaf 400 mm granite wall, a common heavy Ladakhi wall type.',
  ...
  },
  {
    ...
    source: 'BLUEPRINT.md Appendix B; a single-leaf 400 mm rammed-earth wall, the classic Ladakhi wall type.',
  ...
  },
  {
    ...
    blurb: 'A rammed-earth wall wrapped in foam insulation on the outside, keeping the earth mass warm and close to room temperature.',
  },
  {
    ...
    blurb: 'The same rammed-earth wall with the foam insulation moved to the inside face instead. Same total insulation, different behaviour, because the earth mass now sits outside the insulation and tracks outdoor swings more.',
  },
  {
    id: 'firedBrick230',
    name: '230 mm fired brick',
    layers: [{ materialId: 'firedClayBrick', thickness: 0.23 }],
    source: 'BLUEPRINT.md Appendix B; a standard one-brick-thick (230 mm) fired-clay wall, IS 1077 modular brick coursing.',
    blurb: 'A wall built from kiln-fired brick, one brick thick. Sturdy, but not as good at storing heat as a thicker earth wall.',
  },
  {
    id: 'rcc150',
    name: '150 mm RCC',
    layers: [{ materialId: 'rcc', thickness: 0.15 }],
    source: 'BLUEPRINT.md Appendix B; a 150 mm reinforced-concrete slab, the common flat-roof/floor thickness in IS 456 practice.',
    blurb: 'A plain reinforced-concrete slab, most often used as a flat roof or floor rather than a wall.',
  },
  {
    id: 'cgiPuf50',
    ...
    blurb: 'A light metal roof sheet with a foam insulation layer bonded underneath it. Quick to build, insulates much better than bare metal alone.',
  },
  {
    id: 'mudPoplarRoof',
    ...
    blurb: 'The traditional Ladakhi roof: a layer of packed mud over a deck of poplar branches and timber. Simple and local, but a poor insulator.',
  },
  {
    id: 'insulatedRoof',
    ...
    blurb: 'A concrete roof slab with a layer of foam board insulation on top of it. Much warmer than bare concrete alone.',
  },
  {
    id: 'earthFloor',
    name: 'Earth floor',
    ...
    blurb: 'A simple floor of packed earth over a bed of gravel. Cheap and traditional, with no added insulation.',
  },
  {
    ...
    blurb: 'A concrete floor slab with foam insulation underneath it, cutting the steady heat loss straight down into the ground.',
  },
] as const;
