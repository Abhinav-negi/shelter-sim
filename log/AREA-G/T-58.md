...
**Why this exists.** _"If you ask an AI directly 'what insulation should I use in Ladakh?' you get a
plausible-sounding answer drawn from its training data. It might be right. You have no way to check,
and when a DRDO panel asks 'how do you know?', 'the AI said so' is not an answer."_ (`plan.md` §8.)
