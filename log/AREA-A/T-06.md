...
> `KEROSENE_INR_PER_L = 80` write the comment: _no source document states a kerosene price; this is
> an assumption; it is editable in the UI and the PPT must cite whatever value is used._
