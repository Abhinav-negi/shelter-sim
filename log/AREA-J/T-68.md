...
**Why this exists.** _"Survive the first gate, and survive the room."_ Tiers 1–4 of `CHALLENGE.md`
...
> say _"that's your problem"_; the survival grid with its red rows; and end on the
> **recommendation**: _"build this, it costs ₹X more and saves ₹Y a year."_
>
...
>   _"a clear Ladakh night sky sits far below air temperature"_ and the one next to it,
>   _"removing sky radiation makes the shelter measurably warmer at dawn."_
...
>   buggy, which makes it _stronger_ evidence than matching another program. Quote the 300 mm
