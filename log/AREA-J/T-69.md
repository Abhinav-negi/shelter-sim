...
entire audit. The original plan called the PPT _"your first and hardest gate"_ and then scheduled it
...
>
> Cover, across the six slides: the problem in DRDO's own words (_"approach nearly the ambient
> atmospheric temperature after sunset"_); the four outputs (the three named PS deliverables plus the
