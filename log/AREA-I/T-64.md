...
**Why this exists.** _"Every input has a documented, citable source. This is not bureaucracy — it is
the difference between an engineering submission and a demo."_ And `CHALLENGE.md` C-20: **a
...
> no moisture transport (a surface condensation _check_ only);
