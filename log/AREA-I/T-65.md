...
**Why this exists.** `CHALLENGE.md` C-11 and K-02 are the **kill-shot**: _"Show me a case where you
compared this against something other than yourselves."_ This is the single most likely question to
...
3. `VALIDATION.md` (T-63) can state _"we track EnergyPlus within **X %** on case **Y**"_ with X and
