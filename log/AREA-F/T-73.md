...
3. With `store.online = false`, the banner shows the literal text _"Offline — showing 1 scenario,
   AI advice unavailable."_ — re-run T-52's own acceptance test 10 through the real shell this time,
