...
**Why this exists.** _"This is the screen that answers the question a procurement officer actually
has, which is not 'what is the average performance' but 'will this keep people safe on the worst day
this place has ever had?'"_ (`plan.md` §6.) A tool that takes four hours per run **structurally
