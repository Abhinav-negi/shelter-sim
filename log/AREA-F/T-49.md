...
**Why this exists.** _"The Sankey is the most persuasive single image in the app. It answers 'where
is my heat going?' for someone with no technical background, in one glance, with no explanation
needed. You can literally point at the widest outgoing stream and say 'that's your problem.'"_
