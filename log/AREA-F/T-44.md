...
**Why this exists.** _"A tool that opens onto forty numeric input boxes is a tool nobody finishes
using."_ (`plan.md` Part 3.) `CHALLENGE.md` C-13 makes this testable: hand the tool to someone who
...
> — _"Mud brick: cheap, made locally, good at holding daytime heat"_ — with the physical constants
