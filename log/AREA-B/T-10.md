...
2. The star node carries zero capacity. 4. `normaliseAzimuth` is stable under ±360°.
3. A 360° building rotation reproduces results exactly (validation Test 8). 6. `assemble.ts`
